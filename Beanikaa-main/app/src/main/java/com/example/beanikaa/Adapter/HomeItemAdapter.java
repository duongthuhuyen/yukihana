...
public class HomeItemAdapter extends RecyclerView.Adapter<HomeItemAdapter.ViewModel>{
    ...
    public void onBindViewHolder(@NonNull ViewModel holder, int position) {
      //  int img = context.getResources().getIdentifier(homeItemModelList.get(position).getImage(),"drawable",context.getPackageName());
        //System.out.println("hello:"+img);
       // holder.imageView.setImageResource(img);
        String url = "http://192.168.0.100/androidapi/upload/"+homeItemModelList.get(position).getImage()+".jpg";
